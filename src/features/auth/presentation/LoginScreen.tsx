                    ...
                    <View style={styles.centerWrap}>
                        <View style={styles.phoneShell}>
                            ...
                            >
                                ...
                                >
                                    <PillCharacter color="coral" status="taken" size={120} />
                                </Animated.View> */}
                                    <Animated.View
                                        style={{
                                            transform: [{ translateY: mascotFloat }],
...
// import { useLoginAnimations } from "../hooks/useSplashAnimations";
// import { txtfield_styles } from "../components/inputs/textfield_styles";
...
//     const animations = useLoginAnimations(isLoading);
...
//         () =>
//             isLoading
//                 ? colors.gradientLoading
//                 : colors.gradientLogin,
//         [isLoading]
//     );
...
//                             contentContainerStyle={styles.content}
//                             showsVerticalScrollIndicator={false}
//                             style={{ opacity: animations.contentOpacity }}
//                         >
//                             {/* LOGO */}
...
//                                     styles.mascotSection,
//                                     {
//                                         opacity: animations.mascotOpacity,
//                                         transform: [{ translateY: animations.mascotTranslateY }],
//                                     },
//                                 ]}
//                             >
//                                 <Animated.View
//                                     style={{
//                                         transform: [{ translateY: animations.mascotFloat }],
//                                     }}
//                                 >
//                                     <LoginMascot size={120} />
//                                 </Animated.View>
...
//                                     styles.section,
//                                     {
//                                         opacity: animations.bannerOpacity,
//                                         transform: [{ translateY: animations.bannerTranslateY }],
//                                     },
//                                 ]}
//                             >
//                                 <LinearGradient
...
//                                             <View>
//                                                 <Text style={styles.bannerTitle}>
//                                                     {STRINGS.joinBannerTitle}
//                                                 </Text>

//                                                 <Text style={styles.bannerSubtitle}>
//                                                     {STRINGS.joinBannerSubtitle}
//                                                 </Text>
//                                             </View>
//                                         </View>
...
//                                     styles.section,
//                                     {
//                                         opacity: animations.badgesOpacity,
//                                         transform: [{ translateY: animations.badgesTranslateY }],
//                                     },
//                                 ]}
//                             >
...
//                                     styles.section,
//                                     {
//                                         opacity: animations.formOpacity,
//                                         transform: [{ translateY: animations.formTranslateY }],
//                                     },
//                                 ]}
//                             >
//                                 <View style={txtfield_styles.formBlock}>
//                                     <Text style={txtfield_styles.label}>{STRINGS.emailLabel}</Text>

//                                     <Animated.View
//                                         style={{ transform: [{ scale: animations.emailScale }] }}
//                                     >
//                                         <TextInput
//                                             value={email}
...
//                                                 animations.focusEmail();
//                                             }}
//                                             onBlur={() => {
//                                                 setFocusedField(null);
//                                                 animations.blurEmail();
//                                             }}
//                                             placeholder="you@example.com"
//                                             placeholderTextColor="#9CA3AF"
//                                             keyboardType="email-address"
...
//                                 <View style={txtfield_styles.formBlock}>
//                                     <Text style={txtfield_styles.label}>{STRINGS.passwordLabel}</Text>

//                                     <Animated.View
//                                         style={{ transform: [{ scale: animations.passwordScale }] }}
//                                     >
//                                         <TextInput
//                                             value={password}
...
//                                                 animations.focusPassword();
//                                             }}
//                                             onBlur={() => {
//                                                 setFocusedField(null);
//                                                 animations.blurPassword();
//                                             }}
//                                             placeholder="••••••••"
...
//                                     styles.section,
//                                     {
//                                         opacity: animations.loginOpacity,
//                                         transform: [
//                                             { translateY: animations.loginTranslateY },
//                                             { scale: animations.buttonPulse },
//                                         ],
//                                     },
//                                 ]}
//                             >
...
//                                                     style={[
//                                                         styles.loginLoadingEmoji,
//                                                         { transform: [{ rotate: animations.spin }] },
//                                                     ]}
//                                                 >
//                                                     💊
//                                                 </Animated.Text>
...
//                                     styles.section,
//                                     {
//                                         opacity: animations.signupOpacity,
//                                         transform: [
//                                             { translateY: animations.signupTranslateY },
//                                         ],
//                                     },
//                                 ]}
//                             >
...
//                                     styles.section,
//                                     {
//                                         opacity: animations.bottomOpacity,
//                                         transform: [
//                                             { translateY: animations.bottomTranslateY },
//                                         ],
//                                     },
//                                 ]}
//                             >
...
//                                     <Text style={styles.bottomCardSubtitle}>
//                                         {STRINGS.averageText}{" "}
//                                         <Text style={styles.bottomCardBold}>23 days</Text>
//                                     </Text>
//                                 </View>
//                             </Animated.View>
